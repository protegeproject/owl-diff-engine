...
public class OpenAndCompare {
    private static Logger logger = LoggerFactory.getLogger(OpenAndCompare.class.getName());
    ...
    public static void main(String[] args) throws OWLOntologyCreationException, InstantiationException, IllegalAccessException, IOException {
        StopWatch watch = new StopWatch(LoggerFactory.getLogger(OpenAndCompare.class.getName()));
